...
\begin{itemize}
\item foo \cite{nguyenComparativeStudyQuality2024}
\item bar
...
\begin{itemize}
	\item gold-standard data generation
	\item mention how GenAI was used (e.g. to generate text, data, graphics, assist in analysis, interpretation, ..)
	\item The use of GenAI for superficial text editing (e.g., grammar, spelling, punctuation, and formatting) does not need to be declared.
\end{itemize}
