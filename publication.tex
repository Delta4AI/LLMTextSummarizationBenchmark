...
\Title{A systematic evaluation and benchmarking of summarization methods for biomedical literature: From word-frequency methods to language models}
...
% TBD -> add IDs for other authors

% Authors, for the paper (add full first names)
\Author{Fabio Baumgärtel $^{1,\dagger}$\orcidA{}, Enrico Bono $^{1,2,\dagger}$\orcidB{}, Lucas Fillinger $^{1}$, Louiza Galou $^{1}$, Kinga Keska-Izworska $^{1}$, Samuel Walter $^{1}$, Peter Andorfer $^{1}$, Klaus Kratochwill $^{1,2}$, Paul Perco $^{1,3}$\orcidC{} and Matthias Ley $^{1,2}$\orcidD{}*}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
      ...
      \abbreviations{Abbreviations}{
            ...
            \acro{EDM}{Encoder-Decoder Model}
            ...
            \acro{CPT}{Continual Pre-Training}
            ...
            \acro{BART}{Bidirectional and Auto-Regressive Transformer}
            \acro{T5}{Text-to-Text Transfer Transformer}
            \acro{PEGASUS}{Pre-training with Extracted Gap-sentences for Abstractive Summarization Sequence-to-sequence}
            ...
            \acro{DeBERTa}{Decoding-enhanced BERT with Disentangled Attention}
            \acro{MPNet}{Masked and Permuted Pre-training}
