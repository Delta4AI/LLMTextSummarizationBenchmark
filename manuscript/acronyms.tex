  ...
  \acrodef{LCS}{longest common subsequence}
  \acrodef{SEM}{standard error of the mean}
  \acrodef{TRIPOD}{transparent reporting of a multivariable prediction model for individual prognosis or diagnosis}
